...
![](ressources/images/travaux_pratiques-2000007F000025D900001EC4020A82B8.svm)
...
## CSS
Dans le précédent exercice, nous avons mis en place la structure des pages d'accueil et d'inscription. Il est maintenant temps de les rendre présentables, en leur appliquant un style graphique sympathique.  
...
- Créez un div d'id "mapCanvas" après la section contenant les actualités
...
### Drag & Drop
La conférence propose un certain nombre de sujets, parmi lesquels l'utilisateur doit choisir. Pour cela, nous allons lui proposer une interface de type drag&drop, très intuitive.  
...
Dans le fichier loadData.js, la variable liste contient le nombre de conférences sélectionnées par l'utilisateur, par catégorie. Une simple règle de trois suffira donc à calculer la popularité relative de chaque catégorie.  
Utilisez l'API Canvas pour tracer un graphique en barres à partir de ces valeurs.  
  
Bonus : animer le graphique lors du chargement de la page.  
