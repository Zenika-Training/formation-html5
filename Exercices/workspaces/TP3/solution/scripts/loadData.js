var conference =  [{
    ...
    day: '27 May',
    time: '4:55pm - 5:55pm',
    description: 'In this talk, we will go through a short introduction to ElasticSearch, and then deep dive into its distributed nature, its cloud "readiness", and samples of how some of its powerful features like facets and percolator can be used.',
    speaker: 'banon'
}, {
    id: "talk12",
...
liste["outils"]=0;
/*
* fonction chargeant les conferences dans agenda.html
*/
function loadConf(jsonObj) {
...
/*
* fonction chargeant les conferences dans agenda-edit.html
*/
